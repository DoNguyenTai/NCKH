...
<head>
    ...
    <title>Quản Lý Đơn Học Vụ</title>
...
<body>
    <!-- ========== MAIN CONTENT ========== -->
<!-- Breadcrumb -->
<div class="sticky top-0 inset-x-0 z-20 bg-gray-100 border-y border-gray-200 px-4 sm:px-6 lg:px-8 lg:hidden dark:bg-neutral-800 dark:border-neutral-700">
  ...
  <div class="flex">
    ...
    <!-- Content -->
    <div class="w-[85%] h-screen bg-gray-100 ">
            <?php echo e($slot); ?>
...
</html><?php /**PATH /Users/maccato/Local Sites/nckh/app/public/resources/views/components/admin-layout.blade.php ENDPATH**/ ?>